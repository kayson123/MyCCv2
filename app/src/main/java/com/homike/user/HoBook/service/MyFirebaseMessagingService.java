...
import com.homike.user.HoBook.MainActivity;
import com.homike.user.HoBook.SearchActivity;
...
//this class receives the firebase messages into onMessageReceived
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                System.out.println("Message from MyFirebaseMessagingService: " + message);
